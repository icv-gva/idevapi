...
L.Control.Consulta = L.Control.extend({
	options: {
		collapsed: false,
		position: 'topright',
		label: null
  ...
  _initLayout: function () {
		var className = 'leaflet-control-layers',
				classNameContainer = 'leaflet-control-layers control-consulta',
		...
		link.href = '#';
		link.title = MENSAJES.etiquetaConsultas;
		if (L.Browser.touch) {
...
L.control.consulta = function (html,mapa, options) {
        return new L.Control.Consulta(html,mapa, options);
};
