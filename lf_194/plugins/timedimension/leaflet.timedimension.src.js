...
(function (factory, window) {
  ...
  L.TimeDimension = (L.Layer || L.Class).extend({
      ...
      initialize: function (options) {
          ...
          //formato de la fecha en el control. Por defecto es DD/MM/YYYY
          this._formatDate = this.options.formatDate || 'DD/MM/YYYY';
      },
  ...
  L.TimeDimension.Layer.WMS = L.TimeDimension.Layer.extend({
      ...
      initialize: function(layer, options) {
          ...
          this.formatDate = this.options.formatDate || 'DD/MM/YYYY';
      ...
      _createLayerForTime:function(time){
         ...
         //  AF Cada capa puede tener su propio formato de parametro time
          wmsParams.time = moment.utc(time).format(this.formatDate);
  ...
  */
      ...
      _getDisplayDateFormat: function(date) {
          var formattedTime = moment.utc(date).format(this._timeDimension._formatDate);
