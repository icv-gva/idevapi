!function (e) {
        ...
        function r(e, t) {
            ...
            return !!(
                t = null == t
                    ? n
                    : t
            ) && ("number" == r || "symbol" != r && o.test(e)) && e > -1 && e % 1 == 0 && e < t
        }
        var n = 9007199254740991,
            o = /^(?:0|[1-9]\d*)$/;
        e.exports = r
    ...
    function (e, t, r) {
        function n(e, t) {
            ...
            for (var y in e) 
                !t && !f.call(e, y) || h && (
                    "length" == y || c && ("offset" == y || "parent" == y) || p && ("buffer" == y || "byteLength" == y || "byteOffset" == y) || u(y, m)
                ) || d.push(y);
            return d
        }
        var o = r(51),
    ...
    function (e, t, r) {
        function n(e) {
            if (!i(e)) 
                return !1;
            var t = o(e);
            return t == u || t == a || "string" == typeof e.message && "string" == typeof e.name && !s(
                e
            )
        }
        var o = r(0),
        ...
        L.Control.Measure = L
            ...
            .extend({
                ...
                _initLayout: function () {
                    ...
                    t.setAttribute("aria-describedby", "vMedir"),
                    L
                        .DomEvent
                    ...
                    L.Browser.touch
                        ? L
                            .DomEvent
                            .on(r, "click", this._expand, this)
                        : L
                            .DomEvent
                            .on(r, "focus", this._expand, this),
                    L
                        .DomEvent
                        .on(n, "click", L.DomEvent.stop),
                    L
                        .DomEvent
                        .on(n, "click", this._startMeasure, this),
                    L
                        .DomEvent
                        .on(o, "click", L.DomEvent.stop),
                    L
                        .DomEvent
                        .on(o, "click", this._finishMeasure, this),
                    L
                        .DomEvent
                        .on(i, "click", L.DomEvent.stop),
                    L
                        .DomEvent
                        .on(i, "click", this._handleMeasureDoubleClick, this)
                },
                _expand: function () {
                    f.hide(this.$toggle),
                ...
                _startMeasure: function () {
                    this._locked = !0,
                    this._measureVertexes = L
                        .featureGroup()
                        .addTo(this._layer),
                    this._captureMarker = L
                        .marker(this._map.getCenter(), {
                            clickable: !0,
                            zIndexOffset: this.options.captureZIndex,
                            opacity: 0,
                            //FIX desplazamiento click en marker
                    ...
                    L
                        .DomEvent
                        .on(this._container, "mouseenter", this._handleMapMouseOut, this),
                    this._updateMeasureStartedNoPoints(),
                    this
                        ._map
                        .fire("measurestart", null, !1)
                },
                _finishMeasure: function () {
                    ...
                    L
                        .DomEvent
                        .off(this._container, "mouseover", this._handleMapMouseOut, this),
                    this._clearMeasure(),
                    this
                        ._captureMarker
                ...
                _clearMeasure: function () {
                    ...
                    this
                        ._measureVertexes
                        .clearLayers(),
                    this._measureDrag && this
                        ._layer
                        .removeLayer(this._measureDrag),
                    this._measureArea && this
                        ._layer
                        .removeLayer(this._measureArea),
                    this._measureBoundary && this
                        ._layer
                ...
                _updateResults: function () {
                    ...
                    ////////// Traduce elementos del HTML de la ventana /////////////
                    traduceElementosWidget(this.$results);
                    //////////////////////////////////////////////////////////////////
                },
                ...
                _handleMeasureDoubleClick: function () {
                    ...
                    if (this._finishMeasure(), e.length) {
                        ...
                        $(t._popup._contentNode).addClass('leaflet-popup-content-ancho250');
                        ///////// Traduce textos Popup /////////////////////////////
                        traduceElementosWidget(t._popup._container);
                        ////////////////////////////////////////////////////////////
                    }
                },
                _handleMeasureClick: function (e) {
                    var t = this
                            ._map
                            .mouseEventToLatLng(e.originalEvent),
                        r = this._latlngs[this._latlngs.length - 1],
                        n = this
                            ._symbols
                            .getSymbol("measureVertex");
                    r && t.equals(r) || (
                        ...
                        this._measureVertexes.eachLayer(function (e) {
                            ...
                            e
                                ._path
                                .setAttribute("class", n.className)
                        }),
                ...
                _addNewVertex: function (e) {
                    L
                        .circleMarker(e, this._symbols.getSymbol("measureVertexActive"))
                ...
                _addMeasureArea: function (e) {
                    ...
                    this._measureArea
                        ? this
                            ...
                            .setLatLngs(e)
                        : this._measureArea = L
                            .polygon(e, this._symbols.getSymbol("measureArea"))
                            .addTo(this._layer)
                },
    ...
    function (e, t, r) {
        function n(e, t, r) {
            ...
            var j,
                ...
                P = t.interpolate || b,
                k = "__p += '",
                C = RegExp((t.escape || b).source + "|" + P.source + "|" + (
                    P === p
                        ? g
                        : b
                ).source + "|" + (
    ...
    function (e, t, r) {
        ...
        var o = r(10),
            ...
            h = f.hasOwnProperty,
            d = RegExp(
                "^" + p.call(h).replace(u, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") +
                "$"
            );
        e.exports = n
    },
            ...
            return o(function (t, r) {
                var n = -1,
                    ...
                    a = o > 2
                        ...
                        : void 0;
                for (
                    s = e.length > 3 && "function" == typeof s
                        ? (o--, s)
                        : void 0,
                    a && i(r[0], r[1], a) && (
                        s = o < 3
    ...
    function (e, t, r) {
        function n(e, t, r, n) {
            return void 0 === e || o(e, i[r]) && !s.call(n, r)
                ? t
                : e
        }
        var o = r(6),
    ...
    function (e, t, r) {
        ...
        function n(e, t, r) {
            ...
            var n = r.units,
                ...
                c = Object(i.a)(s[1]),
                f = Object(i.a)(a[1]),
                p = Math.pow(Math.sin(u / 2), 2) + Math.pow(Math.sin(l / 2), 2) * Math.cos(c) * Math.cos(
                    f
                );
    ...
    function (e, t, r) {
        //Primer menú Crear medición y empezar a medir
        e.exports = '<a class="{{ model.className }}-toggle js-toggle controlMedir" href=# title="Medida de distancias y áreas">Medir</a>' +
                '<div class="{{ model.className }}-interaction js-in' +
                'teraction"> <div class="js-startprompt startprompt"> <h3 class="js-idioma" data-string="measureTitulo1">Medida de distancias y áreas</h3>' +
                '<ul class=tasks> <a href=# class="js-start start js-idioma" data-string="measureBotonCrear">Crear nueva medida</a>' +
                '</ul> </div> <div class=js-measuringprompt> <h3 class="js-idioma" data-string="measureTitulo1">Medida de distancias y áreas</h3>' +
                '<p class="js-starthelp js-idioma" data-string="measureDescInicio">Start creating a measurement by adding points to the map</p>' +
                '<div class="js-results results"></div> <ul class="js-meas' +
                'uretasks tasks"> <li><a href=# class="js-cancel cancel js-idioma" data-string="measureCancelar">Cancel</a></li> <li><a' +
                ' href=# class="js-finish finish js-idioma" data-string="measureFinalizar">Finish measurement</a></li> </ul> </div> </di' +
                'v> '
    },
    function (e, t, r) {
        //Menú medición en curso
        e.exports = '<div class=group> <p class="lastpoint heading js-idioma" data-string="measureUltimoPunto">Último punto</p> <p>{{ model.last' +
                'Coord.dms.y }} <span class=coorddivider>/</span> {{ model.lastCoord.dms.x }}</' +
                'p> <p>{{ numberFormat(model.lastCoord.dd.y, 6) }} <span class=coorddivider>/</' +
                'span> {{ numberFormat(model.lastCoord.dd.x, 6) }}</p> </div> <% if (model.poin' +
                'tCount > 1) { %> <div class=group> <p><span class="heading js-idioma" data-string="measureDistancia">Distancia</span>' +
                ' {{ model.lengthDisplay }}</p> </div> <% } %> <% if (model.pointCount > 2) { %' +
                '> <div class=group> <p><span class="heading js-idioma" data-string="measureArea">Area</span> {{ model.areaDisplay }}' +
                '</p> </div> <% } %> '
    },
    function (e, t, r) {
        e.exports = '<h3>Point location</h3> <p>{{ model.lastCoord.dms.y }} <span class=coorddivide' +
                'r>/</span> {{ model.lastCoord.dms.x }}</p> <p>{{ numberFormat(model.lastCoord.' +
                'dd.y, 6) }} <span class=coorddivider>/</span> {{ numberFormat(model.lastCoord.' +
                'dd.x, 6) }}</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Center' +
                ' on this location</a></li> <li><a href=# class="js-deletemarkup deletemarkup">' +
                'Delete</a></li> </ul> '
    },
    function (e, t, r) {
        //Popup de medición de línea realizada con resultados
        e.exports = '<h3 class="js-idioma" data-string="measurePopupLinTitulo">Linear measurement</h3> <p>{{ model.lengthDisplay }}</p> <ul class=" tasks medirPopupBotones"> ' +
                '<li><a href=# class="js-zoomto zoomto js-idioma" data-string="measurePopupCentrar">Center on this line</a></li> <li><a hre' +
                'f=# class="js-deletemarkup deletemarkup js-idioma" data-string="measurePopupBorrar">Delete</a></li> </ul> '
    },
    function (e, t, r) {
        //Popup de medición de área y perímetro realizada con resultados
        e.exports = '<h3 class="js-idioma" data-string="measurePopupTitulo">Area measurement</h3> <p><span class="etiquetasDesc js-idioma" data-string="measurePopupArea">Perímetro</span>{{ model.areaDisplay }}</p> <p><span class="etiquetasDesc js-idioma" data-string="measurePopupPerimetro">Perímetro</span> {{ model.lengthDis' +
                'play }}</p> <ul class="tasks medirPopupBotones"> <li><a href=# class="js-zoomto zoomto js-idioma" data-string="measurePopupCentrar">' +
                'Center on this area</a></li> <li><a href=# class="js-deletemarkup deletemarkup js-idioma" data-string="measurePopupBorrar">Delete</a></li> </ul> '
    }
]);