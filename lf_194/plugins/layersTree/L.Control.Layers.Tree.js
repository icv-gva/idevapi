...
(function (L) {
    ...
    L.Control.Layers.Tree = L.Control.Layers.extend({
        ...
        _setTrees: function (base, overlays) {
            ...
            if (base !== undefined) this._capasNormales = forArrays(base);
            if (overlays !== undefined) this._capasArbol = forArrays(overlays);

            var bflat = iterate(this._capasNormales, {});
            for (var i in bflat) {
                this._addLayer(bflat[i], i);
            }

            var oflat = iterate(this._capasArbol, {}, true);
            for (i in oflat) {
        ...
        _update: function () {
            ...
            this._addTreeLayout(this._capasArbol, true);
            return this._localExpand();
        },
        ...
        _iterateTreeLayout: function (tree, container, overlay, selAllNodes, noShow) {
            ...
            if (tree.layer) {
                ...
                if (radioGroup) {
                    //console.log(tree.layer.visibleInicio);
